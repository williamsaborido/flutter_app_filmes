...
import 'package:app_filmes/modules/movie_detail/widget/movie_detail_content/movie_detail_content_production.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        MovieDetailContentProduction(movie: movie),
